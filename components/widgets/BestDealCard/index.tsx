...
const BestDealCard: React.FC<BestDealCardProps> = ({
    ...
    return (
        ...
        <div className='flex items-center justify-center min-w-16 w-16 h-16 shadow-md rounded-sm border border-[#F9F9F8 ] bg-bg-1000'>
        ...
        <h1 className='font-bold text-sm sm:text-base lg:text-xl text-fg-text-contrast'>{title}</h1>
        <p className='font-normal text-xs sm:text-sm lg:text-lg text-fg-text'>{description}</p>
        </div>
        </div>
    );
  };  
